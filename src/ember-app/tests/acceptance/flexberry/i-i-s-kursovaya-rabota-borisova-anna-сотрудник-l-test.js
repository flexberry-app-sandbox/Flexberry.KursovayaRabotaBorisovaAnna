...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota borisova anna сотрудник l');

test('testing i-i-s-kursovaya-rabota-borisova-anna-сотрудник-l', function(assert) {
