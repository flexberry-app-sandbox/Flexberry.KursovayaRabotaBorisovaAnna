...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota borisova anna товар l');

test('testing i-i-s-kursovaya-rabota-borisova-anna-товар-l', function(assert) {
