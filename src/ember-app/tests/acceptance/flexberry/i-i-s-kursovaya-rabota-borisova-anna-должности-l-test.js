...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota borisova anna должности l');

test('testing i-i-s-kursovaya-rabota-borisova-anna-должности-l', function(assert) {
