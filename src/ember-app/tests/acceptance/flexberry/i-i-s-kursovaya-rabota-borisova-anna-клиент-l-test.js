...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota borisova anna клиент l');

test('testing i-i-s-kursovaya-rabota-borisova-anna-клиент-l', function(assert) {
