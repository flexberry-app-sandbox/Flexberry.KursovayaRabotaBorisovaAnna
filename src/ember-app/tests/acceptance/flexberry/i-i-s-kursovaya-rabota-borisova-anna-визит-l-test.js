...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya rabota borisova anna визит l');

test('testing i-i-s-kursovaya-rabota-borisova-anna-визит-l', function(assert) {
