...
moduleForModel('i-i-s-kursovaya-rabota-borisova-anna-клиент', 'Unit | Serializer | i-i-s-kursovaya-rabota-borisova-anna-клиент', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-borisova-anna-клиент',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
